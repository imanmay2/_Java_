 // 1. Print a matrix in a spiral order.
 
 // 2. Given an array A[] consisting of only 0s, 1s, and 2s. 
...
//13.  WAP that will create an array and also accept an element
