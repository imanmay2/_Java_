// Develop a client server program using even parity scheme in which client 
// sends a data word as a code word  and server receives the same. 
// Then it checks whether there is an error in received data. 
